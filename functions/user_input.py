...
def get_user_input():
    ...
    #time interval input
    if time_series == 1:    # if intraday, then specify time interval
        while True:
            try: 
                print('\nTime Interval\n-------------------\n1. 1min\n2. 5min\n3. 15min\n4. 30min\n5. 60min\n')
        ...
        time_interval = 5   # in case of system error and intraday is called, we have default of hourly
    ...
    while True:
        try: 
            ...
            if time_series == 1:    # if intraday
                earliest_date = today-timedelta(days=60) # 2 months prior to today
    ...
    return_dict = {
        ...
        "time_interval": time_interval_str, # string
